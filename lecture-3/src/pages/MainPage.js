...
function MainPage(props) {
	const imageEl1 = useRef(null);
	const imageEl2 = useRef(null);
	const imageEl3 = useRef(null);
	...
	useEffect(() => {
		...
		observer.observe(imageEl1.current);
		observer.observe(imageEl2.current);
		observer.observe(imageEl3.current);
				...
				<TwoColumns
					...
					columns={[
						<picture>
							...
							<img data-src={main_items} ref={imageEl1} />
						</picture>,
						<Meta
							title={'Items'}
				...
				<TwoColumns
					...
					columns={[
						...
						<picture>
							...
							<img data-src={main_parts} ref={imageEl2}/>
						</picture>
					]}
					mobileReverse={true}
				/>
				<TwoColumns
					...
					columns={[
						<picture>
							...
							<img data-src={main_styles} ref={imageEl3}/>
						</picture>,
						<Meta
							title={'Riding Styles'}
